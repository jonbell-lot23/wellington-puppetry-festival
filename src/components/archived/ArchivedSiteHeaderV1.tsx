...
// Frozen snapshot of the pre-redesign SiteHeader, preserved so /archives/v1
// keeps rendering exactly as the live site looked before the TAHI-style
// relaunch. Do not update this file when the live header changes.
...
const NAV = [
  ...
  { label: 'Wellington Puppetry Festival', href: '/archives/v1', external: false },
